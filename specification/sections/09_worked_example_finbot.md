...
| Evaluation Coverage (Ec) | 0.35 | Self-assessed (Independence Multiplier = 0.60) with Base_Coverage approximately 0.70 (16 of 23 sub-metrics tested) in staging (Fidelity Factor = 0.85). Cn-7 has no admissible execution-budget or loop-control test evidence. Ec = (16/23) x 0.60 x 0.85 = 0.355, rounded to 0.35. |
...
W_(ivp) · IVP = (0.30)(0.45)+(0.25)(0.82)+(0.15)(0.60)+(0.20)(0.55)+(0.10)(0.25) = 0.565
ACI_(composite) = (0.60 × 0.35 × 0.71)^(1/3) = 0.53
IVPmitigation = 0.520;ERS = min(10,1.215 × 0.520 × 1.887 × 10) = 10.0.
```

Finbot therefore scores ERS = 10.0 — the maximum value and a Critical MVT — driven by compound operational risk (CRM = 1.35), containment failure (Cn-6 = 0.25; Cn-7 = 0.00), and low assurance confidence (ACI = 0.53; no behavioral attestation program, so T_behavior binds Tf).
